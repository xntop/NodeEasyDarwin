    ...
    <div class="login-box-body">
        ...
        <form autocomplete="off">
            <div :class="{'form-group':true, 'has-feedback':true,'has-error': errors.has('username')}">
                <input type="text" class="form-control" placeholder="用户名(admin)" v-validate="'required'" data-vv-as="用户名" name="username" v-model.trim="username" @keydown.enter="$el.querySelector('[name=password]').focus()">
